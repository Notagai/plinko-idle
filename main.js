window.onload = () => {
    ...
    // NEW SMOOTH STEP VALUES
    const stepValues = [5000, 4500, 3500, 2500, 1500, 500]; 
    ...
    for (let i = 0; i < numSlots; i++) {
        ...
        let points;
        if (dist < stepValues.length) {
            points = stepValues[dist];
        } else {
            points = 500; 
        }
    ...
    function checkScore(ball) {
        if (ball.y + ball.r >= slotY) {
            ...
            let pct = Math.min(totalScore / 100000, 1) * 100;
